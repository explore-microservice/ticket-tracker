...
CREATE TABLE it_issue (id int NOT NULL, name varchar(255) NOT NULL, description varchar(255), creationdate timestamp NOT NULL, projectid int NOT NULL, sprintid int, creatoruserid int NOT NULL, assigneeuserid int NOT NULL, PRIMARY KEY (id));
