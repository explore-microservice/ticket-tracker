INSERT INTO it_user(id, firstname, lastname, username, password, email, lastloggedin) VALUES (1, 'Kenneth', 'Miller', 'keneth', 'password', 'keneth@email.com', null);
INSERT INTO it_user(id, firstname, lastname, username, password, email, lastloggedin) VALUES (2, 'Diana', 'Book', 'diana', 'password', 'diana@email.com', null);
INSERT INTO it_user(id, firstname, lastname, username, password, email, lastloggedin) VALUES (3, 'Man', 'Fountain', 'man', 'password', 'man@email.com', null);
