...
CREATE TABLE it_user (id int NOT NULL, firstname varchar(50) NOT NULL, lastname varchar(50) NOT NULL, username varchar(20) NOT NULL UNIQUE, email varchar(255) NOT NULL UNIQUE, password varchar(255) NOT NULL, lastloggedin timestamp, PRIMARY KEY (id));
